...
public abstract class QuickUnityPlayerproxyActivity extends UnityPlayerActivity implements Handler.Callback {
	...
	public void doInit() {
		...
		try {
			if ((ContextCompat.checkSelfPermission(this, "android.permission.READ_PHONE_STATE") != 0)
				...
				Log.v(MainActivity.sdktag, "QuickUnityPlayerproxyActivity require permision", null);
			} else {
				...
				Log.v(MainActivity.sdktag, "QuickUnityPlayerproxyActivity have permision", null);
			}
		} catch (Exception e) {
			QuickSDK.getInstance().setInitNotifier(this.initNotify).setLoginNotifier(this.loginNotify)
					.setLogoutNotifier(this.logoutNotify).setPayNotifier(this.payNotify)
			...
			Log.v(MainActivity.sdktag, "QuickUnityPlayerproxyActivity have exception : " + e.getMessage(), null);
		}
	}
		...
		if (grantResults[0] == 0) {
			...
			if (ActivityCompat.shouldShowRequestPermissionRationale(this,
				...
				if (ActivityCompat.shouldShowRequestPermissionRationale(this, "android.permission.READ_PHONE_STATE")) {
					Log.v("Unity", "ActivityCompat shouldShowRequestPermissionRationale true");
					return;
				}
			}
	...
	public void setUnityGameObjectName(String gameObjectName) {
		...
		Log.v("lyy", "gameObjectName=" + gameObjectName);
	...
	public boolean handleMessage(Message msg) {
		...
		case 104:
			...
			break;
		case 105:
			Log.v("unity.support", "update role info");
