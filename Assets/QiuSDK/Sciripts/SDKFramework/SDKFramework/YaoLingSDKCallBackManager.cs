...
public class YaoLingSDKCallBackManager : MonoBehaviour
{
    ...
    private static AndroidJavaClass AndJC
    {
        get
        {
            if (andJC == null)
            {
                U3DTypeSDK.DebugLog("AndroidJavaObject 初始化!");
    ...
    {
        U3DTypeSDK.DebugLog("登入回调参数：" + arg);
    ...
    {
        U3DTypeSDK.DebugLog("支付回调参数：" + arg);
    ...
    {
        U3DTypeSDK.DebugLog("收到账号注销结果：" + arg);
    ...
    {
        U3DTypeSDK.DebugLog("unity: 收到账号注销结果：" + arg);
        bool result = arg == "SUCCESS";
        if (onSDKLogoutComplete != null)
        {
            onSDKLogoutComplete(result);
    ...
    public void CallAndroidFunc(YaoLinAndroidSDKNameType funcType, params object[] args)
    {
        try
        {
            ...
            U3DTypeSDK.DebugLog("CallYaoLinSDK:" + funcName);
        ...
        {
            U3DTypeSDK.DebugLog(e.Message, U3DTypeSDK.DebugType.LogError);
        }
    }
    #endregion
