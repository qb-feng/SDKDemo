...
//            androidSupport.init();
		...
		[DllImport("__Internal")]
		private static extern void quicksdk_nativeUpdateRoleInfo(string serverId, string serverName, string gameRoleName, string gameRoleId, string gameRoleBalance, string vipLevel, string gameRoleLevel, string partyName, bool isCreate);
		[DllImport("__Internal")]
